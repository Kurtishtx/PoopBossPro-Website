...
async function sbpCreateAccount(n: number) {
  ...
  try {
    ...
    /* Google Ads conversion: Poopbosspro Trial Sign-up */
    try { (window as any).gtag?.('event', 'conversion', { send_to: 'AW-994175437/l_uRCMm9vtgcEM3Th9oD', value: 79.0, currency: 'USD' }); } catch {}
