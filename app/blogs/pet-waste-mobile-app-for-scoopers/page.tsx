...
export const metadata = {
  title: 'The Mobile App That Runs a Pooper Scooper Crew in the Field | PoopBossPro',
  description: 'See how the PoopBossPro mobile app runs a pooper scooper crew in the field with ordered routes, gate codes, dog counts, photos, and one-tap completion.',
};
