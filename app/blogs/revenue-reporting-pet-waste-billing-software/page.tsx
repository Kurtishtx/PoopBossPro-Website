...
export const metadata = {
  title: 'Revenue Reporting: Reading the Numbers in Your Pet Waste Billing Software | PoopBossPro',
  description: 'Learn how PoopBossPro revenue reports surface MRR, churn, and route profit so your pet waste removal business makes decisions from real numbers.',
};
