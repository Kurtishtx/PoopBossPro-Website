...
export const metadata = {
  title: 'In-App Time Tracking: Accurate Clock-In And Clock-Out For Scoop Crews | PoopBossPro',
  description: 'See how PoopBossPro in-app time tracking captures accurate clock-in and clock-out for pet waste scoop crews, tied to real yards for honest payroll.',
};
