...
export const metadata = {
  title: 'Scaling From One Truck to a Crew With Pet Waste Software | PoopBossPro',
  description: 'How pet waste software lets a solo scooper scale to a crew with shared yard profiles, recurring schedules, route building, dispatch, and card-on-file billing.',
};
