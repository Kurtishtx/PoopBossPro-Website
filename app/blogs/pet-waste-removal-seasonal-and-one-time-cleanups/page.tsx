...
export const metadata = {
  title: 'Managing One-Time And Seasonal Cleanups In Pet Waste Removal Software | PoopBossPro',
  description: 'See how pet waste removal software handles one-time and seasonal yard cleanups with scheduling, routing, card-on-file billing, and customer texts.',
};
