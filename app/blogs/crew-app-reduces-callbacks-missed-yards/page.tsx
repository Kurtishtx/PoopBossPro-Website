...
export const metadata = {
  title: 'How The Crew App Cuts Callbacks And Missed Yards On Pet Waste Routes | PoopBossPro',
  description: 'See how the PoopBossPro crew app cuts callbacks and missed yards on pet waste routes with stop lists, photo proof, gate codes, and live GPS tracking.',
};
