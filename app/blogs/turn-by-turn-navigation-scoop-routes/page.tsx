...
export const metadata = {
  title: 'Turn-By-Turn Navigation: Getting New Scoop Techs To Every Yard Without Guessing | PoopBossPro',
  description: 'See how turn-by-turn navigation in the PoopBossPro crew app gets new scoop techs to every yard in order, no guessing, no missed stops, no calls to dispatch.',
};
