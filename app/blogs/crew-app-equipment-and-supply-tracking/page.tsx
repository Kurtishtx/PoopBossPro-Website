...
export const metadata = {
  title: 'Tracking Bags, Bins, And Supplies From The Field With The Crew App | PoopBossPro',
  description: 'See how PoopBossPro&apos;s crew app tracks waste bags, bins, and supplies from the field so your pet waste removal trucks never run out mid-route.',
};
