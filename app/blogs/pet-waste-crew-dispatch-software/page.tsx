...
export const metadata = {
  title: 'Crew Dispatch Software That Keeps Pooper Scooper Routes On Time | PoopBossPro',
  description: 'See how PoopBossPro crew dispatch software keeps pooper scooper routes on time with smart assignments, live status, gate codes, and customer texts.',
};
