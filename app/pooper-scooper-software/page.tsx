...
export default function PooperScooperSoftware() {
  useEffect(() => {
  ...
  return (
    <>
      ...
      <div className="hero">
        ...
        <h1>Pooper Scooper Business Software<br /><span>Built for How You Actually Work</span></h1>
        <p>Most field service software is built for plumbers and HVAC techs. PoopBossPro is built from the ground up for pooper scooper and pet waste removal businesses &mdash; the way you schedule recurring yard cleanups, build routes, dispatch crews, and bill monthly subscriptions is completely different, and your software should be too.</p>
        ...
        <div className="hero-stats">
          ...
          <div><div className="hero-stat-val">From $49</div><div className="hero-stat-lbl">Three Plans &mdash; No Add-Ons</div></div>
      ...
      <div className="premium-band">
        ...
        <div className="premium-grid">
          ...
          <div className="premium-card"><div className="premium-card-icon">💳</div><h4>Card-on-File Billing</h4><p>Cards on file, monthly subscription charges, invoicing, charge after service, payment tracking, overdue reports &mdash; the full Stripe integration is wired in. Customers pay automatically and you see every dollar collected in one place.</p></div>
          <div className="premium-card"><div className="premium-card-icon">🔐</div><h4>Role-Based Access</h4><p>Owner, Manager, Office Staff, Scooper, and Mobile-only roles. Granular permission control so your field crews only see what they need and your office manager can&apos;t accidentally delete a client record.</p></div>
          <div className="premium-card"><div className="premium-card-icon">📱</div><h4>Mobile App for Your Crew</h4><p>Your scoopers get a mobile-optimized dashboard with their yards for the day &mdash; gate codes, number of dogs, and special notes included. Complete, skip, reschedule, and snap a finished-yard photo all from the truck without calling the office once.</p></div>
        </div>
      </div>
      ...
      <section className="dark-section">
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p style={{color:'rgba(255,255,255,.65)'}}>Lasso is the fastest way to build a pet waste removal route we&apos;ve ever seen. Draw a circle on your service area map and PoopBossPro instantly surfaces every property inside that radius with a cleanup due &mdash; with total yards, cleanup frequencies, stops, and recurring revenue all calculated in real time before you commit to a single schedule.</p>
            <ul className="check-list" style={{marginTop:'20px'}}>
              <li style={{color:'rgba(255,255,255,.75)'}}>Draw any size circle on the map &mdash; instantly see all yards inside</li>
              <li style={{color:'rgba(255,255,255,.75)'}}>Breaks out stops and yards by cleanup frequency automatically</li>
              ...
              <li style={{color:'rgba(255,255,255,.75)'}}>Works across all your cleanup plans simultaneously in one view</li>
          ...
          <div className="highlight-visual">
            ...
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                ...
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Yards Waiting</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px'}}>
                <div style={{color:'#f0820e', fontSize:'18px', fontWeight:800}}>31</div>
              ...
              <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', gridColumn:'span 2'}}>
                <div style={{color:'#fff', fontSize:'13px', fontWeight:600}}>Weekly · 8 &nbsp;|&nbsp; Twice-Weekly · 6 &nbsp;|&nbsp; Biweekly · 5</div>
                <div style={{color:'rgba(255,255,255,.42)', fontSize:'11px', marginTop:'1px'}}>Breakdown by Cleanup Plan</div>
              </div>
            </div>
          </div>
        </div>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto 56px'}}>
          ...
          <h2 className="section-title">The Most Capable Pooper Scooper Software Is Also the Easiest to Learn</h2>
          <p className="section-sub" style={{maxWidth:'720px'}}>Most powerful software is complicated. PoopBossPro is the exception. Every screen was designed by people who ran pet waste removal routes &mdash; not UX designers who&apos;ve never opened a backyard gate. Your team will be using it confidently on day one.</p>
        </div>
        <div style={{display:'grid', gridTemplateColumns:'repeat(auto-fit, minmax(240px, 1fr))', gap:'24px', maxWidth:'1100px', margin:'0 auto'}}>
          {[
            {n:'01', title:'Set Up in One Afternoon', body:'Add your cleanup plans, import your clients and yard profiles, set up your automated alerts, and connect Stripe — most owners are fully operational the same day they sign up. No implementation consultant, no onboarding call, no 90-day setup timeline.'},
            {n:'02', title:'One Screen Does Everything', body:'Scheduling, dispatch, waiting list, map, and yard profiles are all connected. You\'re not jumping between five different modules or browser tabs. Pull up the dispatch board and everything you need for the day—gate codes, dog counts, notes—is right there in a single view.'},
            {n:'03', title:'Your Scoopers Learn It in Minutes', body:'The mobile app your crews use shows them exactly what they need and nothing they don\'t. Their yards for the day, the gate code, the number of dogs, the job notes, and the complete button. No training videos, no IT ticket, no frustrated crew members.'},
            {n:'04', title:'Automation Runs Without You', body:'Set up your SMS alerts, estimate follow-ups, and payment reminders once. After that, PoopBossPro handles every notification, every recurring visit, and every review request automatically — whether you\'re on a route, at home, or on vacation.'},
          ].map(({n, title, body}) => (
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <p className="section-sub">Pet waste removal is not plumbing. You&apos;re not sending one tech to one job for two hours. You&apos;re managing hundreds of yards, multiple cleanup frequencies, gate codes, dog counts, monthly subscriptions, and a waiting list that never stops growing.</p>
        </div>
        <div style={{maxWidth:'900px', margin:'0 auto'}}>
          <div style={{background:'#fff', border:'1.5px solid var(--border)', borderRadius:'14px', padding:'36px 40px', borderLeft:'5px solid var(--orange)'}}>
            <p style={{fontSize:'17px', color:'var(--text)', lineHeight:1.8, marginBottom:'16px'}}>When we were running our own scooping routes, we tried every piece of software out there. The big names, the small names, the ones built for &quot;field service.&quot; None of them understood what it meant to have <strong>800 yards on recurring plans</strong> and need to know exactly how many weekly cleanups you have waiting before you dispatch a single crew.</p>
      ...
      <section>
        ...
        <div className="feature-grid">
          {[
            {icon:'📋', title:'Yard Cleanup Waiting List', body:'Before you schedule a single stop, PoopBossPro shows you exactly how many yards are waiting for every cleanup plan on your list. Know how many weekly, twice-weekly, and biweekly visits you can fit in a day before you make a single call.'},
            ...
            {icon:'🔁', title:'Recurring Cleanup Scheduling', body:'Set a yard to weekly, twice-weekly, or biweekly once and PoopBossPro auto-generates every future visit. No re-entering the same stop fifty-two times a year — the schedule builds itself.'},
            {icon:'🏠', title:'Yard & Property Profiles', body:'Every property has its own record — gate code, number of dogs, yard size, cleanup history, photos, GPS coordinates, and special access notes. Everything tied to the address, not just the customer.'},
            ...
            {icon:'💰', title:'Estimates That Close', body:'Build a pet waste removal quote in minutes from your plan catalog, email it directly from the platform, and let clients accept with one click. Auto-follow-ups go out if they don\'t respond.'},
            {icon:'💳', title:'Card-on-File & Monthly Subscriptions', body:'Store cards on file via Stripe and bill monthly subscriptions automatically. Charge after each cleanup or run flat monthly plans — collect payments without chasing anyone down. Every dollar tracked in one place.'},
            {icon:'📱', title:'Mobile App for Scoopers', body:'Your crews get a mobile-optimized view of their yards for the day — gate codes, dog counts, and notes included. Mark visits complete, skip, or reschedule right from the truck without calling the office.'},
            {icon:'🐕', title:'Number-of-Dogs Tracking', body:'Track how many dogs are at every property so your crews know what they\'re walking into and your pricing reflects the real workload. The dog count rides along on every visit and every estimate.'},
            ...
            {icon:'🔁', title:'Estimate Follow-Up Sequences', body:'3 automated follow-up texts go out if a client doesn\'t respond to your estimate. Let PoopBossPro chase the deal so you don\'t have to.'},
            ...
            {icon:'👥', title:'Client & Lead Management', body:'Manage existing clients and active prospects side by side. Track estimates, cleanup history, and notes all tied to each contact — with a full searchable database.'},
            ...
            {icon:'🏷️', title:'Discount Codes & Sales Tax', body:'Apply percentage or fixed-dollar discounts to any estimate or plan. Set sales tax rates by jurisdiction and let PoopBossPro calculate and track tax on every invoice automatically.'},
            ...
            {icon:'🚛', title:'Truck & Crew Management', body:'Create truck and crew profiles, assign vehicles to routes, and track which crew handled each yard. Know exactly who was where every day.'},
            ...
            {icon:'👥', title:'Never Priced Per Seat', body:'Add every employee, office staff member, and scooper without a per-user fee — your plan sets the number, and Crew lifts it entirely. Unlimited users on Crew at $169/month.'},
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="highlight-row">
          <div className="highlight-text">
            ...
            <p>This is the feature no other pet waste removal software has. PoopBossPro&apos;s waiting list doesn&apos;t just show you what yards need a cleanup &mdash; it shows you the total visits broken down by cleanup plan so you know exactly how much you can fit in a day before you start making calls. For a closer look at how the waiting list, recurring scheduling, and route builder come together as the daily operational hub for a pet waste removal business, read <a href="/blogs/pooper-scooper-software-complete-guide" style={{color:'var(--orange)', fontWeight:600}}>Pooper Scooper Software: The Complete Guide for Pet Waste Removal Businesses</a>.</p>
            <ul className="check-list">
              <li>Waiting list grouped by cleanup plan with yard totals</li>
              ...
              <li>Summary bar: total stops, yards, recurring revenue for the day</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Waiting List — By Cleanup Plan</div>
      ...
      <section>
        <div className="highlight-row reverse">
          <div className="highlight-text">
            ...
            <h2>Monthly Subscriptions and Card-on-File Built for Pet Waste Removal</h2>
            <p>Pet waste removal runs on recurring revenue. PoopBossPro keeps cards on file and bills every monthly subscription automatically &mdash; the cleanup happens, the charge goes through, and you can pull a report on exactly who&apos;s paid and who&apos;s past due in seconds.</p>
            <ul className="check-list">
              <li>Store cards on file securely through Stripe</li>
              <li>Bill flat monthly subscriptions automatically</li>
              <li>Charge per cleanup or per recurring plan</li>
              <li>Track number of dogs and plan price per yard</li>
              <li>Filter by unpaid, partial, paid, or past due</li>
              <li>Failed-charge alerts and automated payment reminders</li>
              <li>Full payment history tied to every client and yard</li>
            </ul>
          </div>
          <div className="highlight-visual">
            <div style={{color:'rgba(255,255,255,.5)', fontSize:'11px', textTransform:'uppercase', letterSpacing:'1px', marginBottom:'14px'}}>Recurring Billing — June 2026</div>
            <div style={{display:'grid', gridTemplateColumns:'1fr 1fr', gap:'8px', marginBottom:'12px'}}>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                ...
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Cleanups</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
              ...
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#f0820e', fontSize:'20px', fontWeight:700}}>$14.2K</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Monthly Recurring</div>
              </div>
              <div style={{background:'rgba(255,255,255,.07)', borderRadius:'8px', padding:'12px', textAlign:'center'}}>
                <div style={{color:'#f0820e', fontSize:'20px', fontWeight:700}}>128</div>
                <div style={{color:'rgba(255,255,255,.45)', fontSize:'11px'}}>Cards On File</div>
              </div>
            </div>
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', marginBottom:'10px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#22c55e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Weekly Plan · 2 dogs</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>J. Smith · Gate code 4412 · Card on file</div></div>
            ...
            <div style={{background:'rgba(255,255,255,.07)', border:'1px solid rgba(255,255,255,.1)', borderRadius:'8px', padding:'12px 14px', display:'flex', alignItems:'center', gap:'12px'}}>
              <div style={{width:'10px', height:'10px', borderRadius:'50%', background:'#f0820e', flexShrink:0}}></div>
              <div style={{flex:1}}><div style={{color:'rgba(255,255,255,.85)', fontSize:'13px', fontWeight:600}}>Twice-Weekly Plan · 3 dogs</div><div style={{color:'rgba(255,255,255,.45)', fontSize:'11px', marginTop:'1px'}}>M. Torres · Reminder sent</div></div>
              <div style={{background:'#f0820e', color:'#fff', fontSize:'11px', fontWeight:700, padding:'3px 9px', borderRadius:'10px'}}>Past Due</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section style={{background:'var(--light-bg)'}}>
        <div className="centered" style={{maxWidth:'1100px', margin:'0 auto'}}>
          ...
          <h2 className="section-title">Priced To Your Size. Everything Included.</h2>
        ...
        <div style={{maxWidth:'520px', margin:'0 auto'}}>
          <div className="lc-price-card featured">
            ...
            <ul className="price-features">
              ...
              <li>Yard Waiting List by Cleanup Plan</li>
              <li>Estimates, Invoices &amp; Stripe Payments</li>
              <li>Two-Way SMS &amp; Automated Alerts</li>
              <li>Recurring Plans &amp; Monthly Subscriptions</li>
              <li>Card-on-File Billing &amp; Past-Due Reports</li>
      ...
      <section style={{background:'#fff'}}>
        <div style={{maxWidth:'860px', margin:'0 auto', padding:'80px 40px'}}>
          ...
          <h2 className="section-title" style={{marginBottom:'48px'}}>Pooper Scooper Software &mdash; Common Questions</h2>
          {[
            {q:'Is PoopBossPro built for pet waste removal businesses?', a:'Yes. PoopBossPro handles the full pooper scooper operation: recurring yard cleanup scheduling, route building, crew dispatch, yard and property profiles with gate codes and dog counts, estimate-to-service conversion, automated customer SMS, card-on-file billing, and monthly subscriptions. It\'s designed for companies running scooping routes, not general service businesses.'},
            {q:'Can I run weekly, twice-weekly, and biweekly cleanup plans in one platform?', a:'Yes. PoopBossPro supports every cleanup frequency from one account, with separate waiting lists by plan. You set a yard to weekly, twice-weekly, biweekly, or one-time once and the software auto-generates every future visit with plan-specific SMS alerts and pricing.'},
            ...
            {q:'How much does PoopBossPro cost?', a:'Three plans — Start $49, Pro $79, Crew $169 a month. Every plan is the same software; the bigger ones lift the seat limits and switch on the automation. No per-user fees, no add-ons for SMS or route tools, no setup fees. 14-day free trial with no credit card required.'},
          ].map(({q, a}, i, arr) => (
          ...
          <p style={{marginTop:'40px', color:'var(--muted)', fontSize:'15px', lineHeight:1.7}}>PoopBossPro runs your entire pet waste removal operation &mdash; recurring scheduling, route building, crew dispatch, card-on-file billing, and customer texts &mdash; all from one platform. See the full platform overview at <a href="/" style={{color:'var(--orange)', fontWeight:600}}>PoopBossPro</a>.</p>
        </div>
      </section>
