      ...
      <section>
        ...
        <div className="feature-grid">
          {[
            ...
            {icon:'👥', title:'Unlimited Users', body:'Add every scooper, office staff member, and crew lead at no extra cost. No per-seat fees. Unlimited users are included in the flat $129/month rate.'},
